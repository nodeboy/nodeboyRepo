...
//u8 testwritebuff[18]="440782198610186699";
//u8 testreadbuff[10];
...
static void led_thread_entry(void* parameter)
{
    ...
    extern void GPRS_Handle();
    while (1)
    {
    	//extern struct rt_device uart2_device;
    	//rt_device_write(&uart2_device, 0, "abcdefghijk\nlmn\n", 16);
...
/* Filesystem Initialization */
#ifdef RT_USING_DFS
	{
		...
		GPIO_SetBits(GPIOE,GPIO_Pin_13);//da kai gprs dinayuan
		GPIO_SetBits(GPIOB,GPIO_Pin_5);//带开lcd背光
