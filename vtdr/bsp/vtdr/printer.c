...
void printfenlei()
{
	...
	for(i=0;i<32;i++)
	{
		...
		print_buf[i][7] = Pri_maohao[i];
		PrinAutoCodeDiff(&print_buf[i][8],i/2);
		...
		do
		{
			...
			if(tsave > tdaytime )
			{
				...
				for(i=0;i<32;i++)
				{
					...
					print_buf[i][2] = ASCII2Print(num+48,i/2);
				...
				for(i=0;i<32;i++)
				{
					...
					print_buf[i][1] = ASCII2Print(50,i/2);
					print_buf[i][2] = ASCII2Print(48,i/2);
					print_buf[i][3] = ASCII2Print((Readdata[18]>>4)+48,i/2);
					print_buf[i][4] = ASCII2Print((Readdata[18]&0x0f)+48,i/2);
					print_buf[i][5] = Pri_Ehx2[i/2];
					print_buf[i][6] = ASCII2Print((Readdata[19]>>4)+48,i/2);
					print_buf[i][7] = ASCII2Print((Readdata[19]&0x0f)+48,i/2);
					print_buf[i][8] = Pri_Ehx2[i/2];
					print_buf[i][9] = ASCII2Print((Readdata[20]>>4)+48,i/2);
					print_buf[i][10] = ASCII2Print((Readdata[20]&0x0f)+48,i/2);

					print_buf[i][12] = ASCII2Print((Readdata[21]>>4)+48,i/2);
					print_buf[i][13] = ASCII2Print((Readdata[21]&0x0f)+48,i/2);
					print_buf[i][14] = Pri_Ehx2[i/2];
					print_buf[i][15] = ASCII2Print((Readdata[22]>>4)+48,i/2);
					print_buf[i][16] = ASCII2Print((Readdata[22]&0x0f)+48,i/2);
					print_buf[i][17] = Pri_Ehx2[i/2];
					print_buf[i][18] = ASCII2Print((Readdata[23]>>4)+48,i/2);
					print_buf[i][19] = ASCII2Print((Readdata[23]&0x0f)+48,i/2);
				...
				for(i=0;i<32;i++)
				{
					...
					print_buf[i][1] = ASCII2Print(50,i/2);
					print_buf[i][2] = ASCII2Print(48,i/2);
					print_buf[i][3] = ASCII2Print((Readdata[24]>>4)+48,i/2);
					print_buf[i][4] = ASCII2Print((Readdata[24]&0x0f)+48,i/2);
					print_buf[i][5] = Pri_Ehx2[i/2];
					print_buf[i][6] = ASCII2Print((Readdata[25]>>4)+48,i/2);
					print_buf[i][7] = ASCII2Print((Readdata[25]&0x0f)+48,i/2);
					print_buf[i][8] = Pri_Ehx2[i/2];
					print_buf[i][9] = ASCII2Print((Readdata[26]>>4)+48,i/2);
					print_buf[i][10] = ASCII2Print((Readdata[26]&0x0f)+48,i/2);

					print_buf[i][12] = ASCII2Print((Readdata[27]>>4)+48,i/2);
					print_buf[i][13] = ASCII2Print((Readdata[27]&0x0f)+48,i/2);
					print_buf[i][14] = Pri_Ehx2[i/2];
					print_buf[i][15] = ASCII2Print((Readdata[28]>>4)+48,i/2);
					print_buf[i][16] = ASCII2Print((Readdata[28]&0x0f)+48,i/2);
					print_buf[i][17] = Pri_Ehx2[i/2];
					print_buf[i][18] = ASCII2Print((Readdata[29]>>4)+48,i/2);
					print_buf[i][19] = ASCII2Print((Readdata[29]&0x0f)+48,i/2);
