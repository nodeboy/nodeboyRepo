...
static
const WCHAR uni2oem[] = {};
		//0x4E01,	0xB6A1, 0x4E11, 0xB3F3, 0x4E19, 0xB1FB, 0x4E59, 0xD2D2,
		//0x4E91,	0xD4C6, 0x4EA5, 0xBAA5, 0x4EAC, 0xBEA9, 0x4F7F, 0xCAB9,
		//0x5180, 0xBCBD, 0x5348, 0xCEE7, 0x536F, 0xC3AE, 0x53F0, 0xCCA8,
		//0x5409,	0xBCAA, 0x5883, 0xBEB3, 0x58EC, 0xC8C9, 0x5B50, 0xD7D3,
		//0x5B66, 0xD1A7, 0x5B81, 0xC4FE, 0x5BC5, 0xD2FA, 0x5DDD, 0xB4A8,
		//0x5DF1, 0xBCBA, 0x5E9A, 0xB8FD, 0x620A, 0xCEEC, 0x62E9, 0xD4F1,
		//0x664B,	0xBDFA, 0x672A, 0xCEB4, 0x6842, 0xB9F0, 0x6CAA, 0xBBA6,
		//0x6D25,	0xBDF2, 0x6D59, 0xD5E3, 0x6D77, 0xBAA3, 0x6E1D, 0xD3E5,
		//0x6E2F, 0xB8DB, 0x6E58, 0xCFE6, 0x6FB3, 0xB0C4, 0x743C, 0xC7ED,
		//0x7518,	0xB8CA, 0x7532, 0xBCD7, 0x7533, 0xC9EA, 0x7696, 0xCDEE,
		//0x82CF,	0xCBD5, 0x8499, 0xC3C9, 0x85CF, 0xB2D8, 0x8826, 0xD042,
		//0x8B66, 0xBEAF, 0x8BD5, 0xCAD4, 0x8C6B, 0xD4A5, 0x8D35, 0xB9F3,
		//0x8D63, 0xB8D3, 0x8F9B, 0xD0C1, 0x8FB0, 0xB3BD, 0x8FBD, 0xC1C9,
		//0x9102,	0xB6F5, 0x9149, 0xD3CF, 0x95FD, 0xC3F6, 0x9655, 0xC9C2,
		//0x9752,	0xC7E0, 0x9886, 0xC1EC, 0x9C81, 0xC2B3, 0x9ED1, 0xBADA,
		//0x9ED4,	0xC7AD, 0,0,0, 0,0,0};
static
//const WCHAR oem2uni[] = {0x8AE4,0x5A41,0xB88B, 0x7B05,0xC9CF,0x4E0A ,0xCFC2,0x4E0B,0xE4B8,0x6D93,0,0,0,0};
const WCHAR oem2uni[] = {
		0xB0C4,0x6FB3, 0xB0E6,0x7248, 0xB1BE,0x672C, 0xB1E0,0x7F16,
		0xB1EA,0x6807, 0xB1FB,0x4E19, 0xB2BF,0x90E8, 0xB2CE,0x53C2,
		0xB2D8,0x85CF, 0xB3AC,0x8D85, 0xB3B5,0x8F66, 0xB3BD,0x8FB0,
		0xB3CC,0x7A0B,  0xB3E5,0x51B2, 0xB3F3,0x4E11, 0xB4A8,0x5DDD,
		0xB5B1,0x5F53, 0xB5E3,0x70B9, 0xB5E7,0x7535, 0xB6A1,0x4E01,
		0xB6A8,0x5B9A, 0xB6C8,0x5EA6, 0xB6F5,0x9102, 0xB7A6,0x4E4F,
		0xB7DD,0x4EFD, 0xB8C4,0x6539, 0xB8CA,0x7518, 0xB8D3,0x8D63,
		0xB8DB,0x6E2F, 0xB8FD,0x5E9A, 0xB9CA,0x6545, 0xB9F0,0x6842,
		0xB9F3,0x8D35, 0xBAA3,0x6D77, 0xBAA5,0x4EA5, 0xBAC5,0x53F7,
		0xBADA,0x9ED1, 0xBBA6,0x6CAA, 0xBCAA,0x5409, 0xBCBA,0x5DF1,
		0xBCBD,0x5180, 0xBCC6,0x8BA1,  0xBCC7,0x8BB0, 0xBCD7,0x7532,
		0xBCDD,0x9A7E, 0xBCE4,0x95F4, 0xBDF2,0x6D25, 0xBDFA,0x664B,
		0xBEA9,0x4EAC, 0xBEAF,0x8B66, 0xBEB3,0x5883, 0xC0DB,0x7D2F,
		0xC1C9,0x8FBD, 0xC0EF,0x91CC, 0xC1BE,0x8F86, 0xC1EC,0x9886,
		0xC2B3,0x9C81, 0xC2BC,0x5F55, 0xC2F6,0x8109, 0xC3AE,0x536F,
		0xC3C9,0x8499, 0xC3F6,0x95FD, 0xC4EA,0x5E74, 0xC4FE,0x5B81,
		0xC5E4,0x914D, 0xC7AD,0x9ED4, 0xC7E0,0x9752, 0xC7ED,0x743C,
		0xC8C9,0x58EC, 0xC8CB,0x4EBA, 0xC8D5,0x65E5, 0xC9C2,0x9655,
		0xC9EA,0x7533, 0xC9ED,0x8EAB, 0xCAB1,0x65F6, 0xCAB9,0x4F7F,
		0xCABB,0x9A76, 0xCAC2,0x4E8B, 0xCAD4,0x8BD5, 0xCAFD,0x6570,
		0xCBD5,0x82CF, 0xCBD9,0x901F, 0xCCA8,0x53F0, 0xCCAC,0x6001,
		0xCDE2,0x5916, 0xCDEE,0x7696, 0xCEA8,0x552F, 0xCEB4,0x672A,
		0xCEBB,0x4F4D, 0xCEE7,0x5348, 0xCEEC,0x620A, 0xCFA2,0x606F,
		0xCFB5,0x7CFB, 0xCFE6,0x6E58, 0xD042,0x8826, 0xD0C1,0x8F9B,
		0xD0C5,0x4FE1, 0xD0D0,0x884C, 0xD0D4,0x6027, 0xD0DE,0x4FEE,
		0xD1A7,0x5B66, 0xD2BB,0x4E00, 0xD2C7,0x4EEA, 0xD2C9,0x7591,
		0xD2D2,0x4E59, 0xD2FA,0x5BC5, 0xD3E5,0x6E1D, 0xD3CF,0x9149,
		0xD4A5,0x8C6B, 0xD4C6,0x4E91, 0xD4F1,0x62E9, 0xD5E3,0x6D59,
		0xD6B4,0x6267, 0xD6BE,0x5FD7, 0xD6C3,0x7F6E,0xD7B4,0x72B6,
		0xD7BC,0x51C6, 0xD7D3,0x5B50, 0xD8DD,0x524D,0,0
};
#if 0
static
const WCHAR uni2oem[] = {
